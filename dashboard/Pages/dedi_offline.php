...
$paginate->init('SELECT * FROM dn_messages WHERE online = "0" ORDER BY id DESC', null);
?>
            <div class="">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content table-responsive">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-round btn-success btn-xs dediValidate" id="<?php echo $data->id; ?>">Valider</button>
                                ...
                                <?php else: ?>
                                    <div class="alert alert-info">Nous n'avez actuellement aucune dédicace à valider.</div>
                                <?php endif; ?>
