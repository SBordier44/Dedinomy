...
$paginate->init('SELECT * FROM dn_users WHERE grade="admin" ORDER BY id DESC', null);
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Utilisateurs :: Liste des Administrateurs</h2>
                                <ul class="nav navbar-right panel_toolbox">
                                    <li><button id="addUser"><i class="fa fa-plus text-success"></i> Ajouter un Administrateur</button>
                                    </li>
                                </ul>
                                <div class="clearfix"></div>
                            </div>
