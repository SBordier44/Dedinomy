...
<div id="container">
	<div id="page">
		...
		<div id="content">
			<div class="progress">
				<?php echo ($this->config['show_steps'] ? $this->language['step'] . $this->vars['step_num'] . $this->language['out_of'] . $this->vars['total_steps'] . ' - ' : '') . $this->step['name']; ?>
			</div>
			...
			<form action="" method="post" name="wizard">
				...
				<div class="buttons">
					<?php if ( $this->config['show_back_button'] && $this->vars['step_num'] > 1 && $this->vars['step_num'] != $this->vars['total_steps'] ): ?>
						<input type="submit" name="button_back" value="<?php echo $this->language['Back']?>" class="button button-back" />
					<?php endif; ?>
					<?php if ( $this->vars['step_num'] < $this->vars['total_steps'] ): ?>
						<input type="submit" name="button_next" value="<?php echo $this->language['Next']?>" class="button button-next" />
					<?php endif; ?>
					<?php if ( $this->vars['step_num'] == $this->vars['total_steps'] ): ?>
						<a href="../dashboard"><input type="button" name="button_done" value="<?php echo $this->language['Done']?>" class="button button-next"/></a>
					<?php endif; ?>
				</div>
			</form>
		</div>
